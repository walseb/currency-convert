...
/* package currency-convert-0.1.1.0 */
#define VERSION_currency_convert "0.1.1.0"
#define MIN_VERSION_currency_convert(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package http-conduit-2.2.0 */
#define VERSION_http_conduit "2.2.0"
...
/* package unordered-containers-0.2.6.0 */
#define VERSION_unordered_containers "0.2.6.0"
...
#define CURRENT_COMPONENT_ID "currency-convert-0.1.1.0-5Q003ypcKPuIsRwjeld1LP"

#define CURRENT_PACKAGE_KEY "5Q003ypcKPuIsRwjeld1LP"
